...
require(script:WaitForChild("EngineNames")).install(common)
...
| 모듈 | 책임 | 주요 API 예시 |
| --- | --- | --- |
| `EngineNames` | Roblox 서비스명, ClassName, 논리 이름, Attribute, 라운드 상태 enum | `eEngineServiceSingleton`, `eEnginePhysicalType`, `eEngineLogicalType`, `eEngineAttributeKey` |
