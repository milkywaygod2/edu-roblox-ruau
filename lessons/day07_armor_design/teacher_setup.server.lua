...
local toolOldTool = serviceStarterPack:FindFirstChild("HeavyArmor")
if toolOldTool then toolOldTool:Destroy() end

local toolHeavyArmor = Instance.new("Tool")
toolHeavyArmor.Name = "HeavyArmor"
toolHeavyArmor.RequiresHandle = true
toolHeavyArmor.ToolTip = "장착하면 갑옷 능력치가 적용됩니다"
toolHeavyArmor.Parent = serviceStarterPack

local partHandle = Instance.new("Part")
partHandle.Name = "Handle"
partHandle.Size = Vector3.new(2, 2, 1)
partHandle.Material = Enum.Material.Metal
partHandle.BrickColor = BrickColor.new("Really black")
partHandle.Parent = toolHeavyArmor
