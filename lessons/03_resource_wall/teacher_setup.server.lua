...
local folderResourceWall03 = createOrReplaceInstance(enumClassName.FOLDER, "ResourceWall03", serviceWorkspace) -- [의미/의도] ResourceWall03 Folder 대체 생성 ➔ 기존 자원 방벽 관련 요소를 삭제하고 3일차 실습판을 초기화하기 위함
