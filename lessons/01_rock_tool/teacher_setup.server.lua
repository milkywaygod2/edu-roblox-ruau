...
local folderArena01 = createOrReplaceInstance(enumClassName.FOLDER, "Arena01", serviceWorkspace) -- [의미/의도] Arena01 Folder 대체 생성 ➔ 기존 폴더를 지우고 깨끗한 새 폴더로 1일차 맵 구성을 시작하기 위함
...
local toolPracticeRock = createOrReplaceInstance(enumClassName.TOOL, "PracticeRock", serviceStarterPack) -- [의미/의도] PracticeRock Tool 대체 생성 ➔ 기존 무기를 지우고 기본 지급용 무기를 초기화하기 위함
