...
local toolBalanceSword = createOrReplaceInstance(enumClassName.Tool, "BalanceSword", serviceStarterPack) -- [의미/의도] BalanceSword Tool 대체 생성 ➔ 기존 근접 검 무기를 지우고 새로운 연습용 검을 배치하기 위함
...
local folderDummies04 = createOrReplaceInstance(enumClassName.Folder, "Dummies04", serviceWorkspace) -- [의미/의도] Dummies04 Folder 대체 생성 ➔ 기존 더미 그룹 폴더를 삭제하고 연습용 더미들을 새로 준비하기 위함
