...
local folderCoverField02 = workspace:WaitForChild("CoverField02")                      -- [의미/의도] Workspace에서 "CoverField02" 폴더가 생성될 때까지 대기 후 가져옴 ➔ 선생님 스크립트가 폴더를 생성할 때까지 대기하여 에러를 방지하기 위함
